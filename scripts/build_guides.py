...
APPS = {
    ...
    'assurance': ('IaaP Assurance', 'Explore bounded authority', 'Work through Sentry, Shield, and custody; follow verified decisions into Portal views for Management, Security, and Governance.', '/assurance/demo/', 'Open Assurance demo'),
